...
from Training.continuous_tab import create_continuous_tab 
...
THEMES = {
    "PoultriScan Dark": {
        ...
        "SUCCESS_TEXT": "#E0E0E0",
        "ACCENT_HOVER": "#FFD43A" # <-- 1. ADDED THIS LINE
    },
    "PoultriScan Light": {
        ...
        "DANGER_TEXT": "#E0E0E0",
        "SUCCESS_TEXT": "#E0E0E0",
        "ACCENT_HOVER": "#F0C419" # <-- 2. ADDED THIS LINE
    }
}
...
class MainWindow(QMainWindow):
    ...
    def create_header(self):
        ...
        header_layout.setContentsMargins(5, 15, 15, 15) 
        ...
        try:
            logo_path = "/home/pi/poultriscan-env/[1]APP/logo.png"
    ...
    def create_content_pages(self):
        ...
        # 5. Continuous (Index 4)
        continuous_tab = create_continuous_tab(self.content_stack, GLOBAL_PALETTE, self, self.gpio_handle)
        self.content_stack.addWidget(continuous_tab)

        # 6. Network (Index 5 - Hidden Tab)
        network_tab = create_network_tab(self.content_stack, GLOBAL_PALETTE, self)
        self.content_stack.addWidget(network_tab)
    ...
    def switch_page(self, index):
        if index < self.content_stack.count():
            ...
            print(f"Warning: Tried to switch to invalid page index {index}")
            self.content_stack.setCurrentIndex(0) # Default to dashboard
