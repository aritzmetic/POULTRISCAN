...
class VirtualKeyboard(QWidget):
    ...
    def __init__(self, palette, parent=None):
        ...
        # --- THIS IS THE FIX ---
        # This prevents the keyboard widget itself from stealing focus
        # when it's clicked, which stops the focusChanged signal
        # from incorrectly closing it.
        ...
        self.setStyleSheet(f"""
            ...
            QPushButton {{
                ...
                border-radius: 4px;
                font: bold 10pt 'Bahnschrift'; /* <-- REDUCED FONT */
                min-width: 28px; /* <-- REDUCED SIZE */
                min-height: 28px; /* <-- REDUCED SIZE */
                padding: 1px; /* <-- ADDED PADDING FOR TIGHTER FIT */
            }}
            QPushButton:pressed {{
        ...
        self.layout.setContentsMargins(3, 3, 3, 3) # <-- REDUCED MARGINS
        ...
        self.setFixedWidth(480) # <-- REDUCED WIDTH
        self.adjustSize()
    ...
    def _init_ui(self):
        ...
        btn_back.setMinimumWidth(40) # <-- REDUCED
        ...
        btn_enter.setMinimumWidth(50) # <-- REDUCED
        ...
        self.btn_shift.setMinimumWidth(40) # <-- REDUCED
        ...
        self.btn_sym.setMinimumWidth(50) # <-- REDUCED
