...
class RawDataViewer(QDialog):
    """
    A dialog window to display the contents of the
    ...
    def __init__(self, palette, parent=None):
        ...
        # Title
        title_label = QLabel("Raw Sensor Data (Individual Iterations - 5x per Test)")
        ...
        self.tree.setStyleSheet(f"font: 9pt 'Bahnschrift';")
...
class ReportsTab(QWidget):
    def __init__(self, palette, root_window, parent=None):
        ...
        self.btn_show_raw.clicked.connect(self.show_raw_data_viewer)
    ...
    def email_report_data(self):
        ...
        label.setFont(QFont("Bahnschrift", 11))
        ...
        if chosen_report == 'main':
            ...
            <html><body><div style="font-family: Arial; padding: 25px; background-color: #f7f7f7;">
                <div style="padding: 30px; border: 1px solid #dddddd; border-radius: 8px; background-color: #ffffff; max-width: 650px; margin: 20px auto;">
                    ...
                    <p>This report includes sample IDs, timestamps, averaged sensor indexes, and the final quality assessment.</p>
            ...
            email_subject = f"PoultriScan RAW DATA LOG (Individual Iterations) :: {date_str} {time_str}"
            email_body = f"""
            <html><body><div style="font-family: Arial; padding: 25px; background-color: #f7f7f7;">
                <div style="padding: 30px; border: 1px solid #dddddd; border-radius: 8px; background-color: #ffffff; max-width: 650px; margin: 20px auto;">
                    <div style="font-size: 20pt; font-weight: bold; color: {primary_color}; border-bottom: 3px solid {accent_color}; padding-bottom: 15px; margin-bottom: 20px;">
                    ...
                    <p>Dear Recipient,</p>
                    <p>The attached CSV file contains the <b>Raw Sensor Data Log</b>.</p>
                    <p><b>NOTE:</b> This file contains 5 rows for every single test run (one row per scan iteration). It is formatted for database import.</p>
                    <p style="font-style: italic; color: #777777; font-size: 10pt; margin-top: 20px;">
    ...
    def load_report_data(self):
        ...
        nodata_font = QFont("Bahnschrift", 9, italic=True)
